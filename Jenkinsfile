    ...
    stage('Validate Tech Debt') {
      steps {     
        withPythonEnv('python3') {
          ...
          sh script :"python3 -u outsystems_cicd_techdebt.py --manifest_file ${env.ArtifactsFolder}/trigger_manifest.cache --techdebt_data ${env.ArtifactsFolder}/techdebt_data"
        }        
      }
    }
  }
