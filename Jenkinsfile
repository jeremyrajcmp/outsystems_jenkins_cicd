    ...
    stage('Validate Tech Debt') {
      steps {     
        withPythonEnv('python3') {
          ...
          // sh script :"python3 techdebt_validation.py --manifest_file \"${env.ArtifactsFolder}/trigger_manifest.cache\" --techdebt_data \"${env.ArtifactsFolder}/techdebt_data\""
          sh "python3 techdebt_validation.py --manifest_file \"${env.ArtifactsFolder}/trigger_manifest.cache\" --techdebt_data \"${env.ArtifactsFolder}/techdebt_data\""
        }        
      }
    }
  }
